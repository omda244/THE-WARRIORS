...
<td>
<select required name="BirthDay" id="Birthday_Day"  >
<option >Day:</option>
...
<select required name="BirthdayMonth" id="Birthday_Month" >
<option >Month:</option>
...
<select required name="BirthdayYear" id="Birthday_Year" >
<option >Year:</option>
...
body {
  ...
  background: -webkit-linear-gradient(to top, #A9A9A9, #A9A9A9);
  background: -moz-linear-gradient(to top, #A9A9A9, #A9A9A9);
  background: -o-linear-gradient(to top, #A9A9A9, #A9A9A9);
  background: linear-gradient(to top, #A9A9A9, #A9A9A9);
...
input[type="text"], input[type="email"], input[type="password"] {
  ...
  background: -webkit-linear-gradient(top, #F0E68C 96%, #fff 4%);
